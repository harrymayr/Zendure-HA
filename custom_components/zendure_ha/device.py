...
class ZendureDevice(EntityDevice, PowerDistribution):
    ...
    def __init__(self, hass: HomeAssistant, deviceId: str, name: str, model: str, definition: dict[str, str], parent: str | None = None) -> None:
        ...
        PowerDistribution.__init__(self)
        self.name = name
