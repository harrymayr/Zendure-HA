...
from .devices.solarflow2400ac import SolarFlow2400AC, SolarFlow2400Pro
...
class Api:
    ...
    createdevice: dict[str, Callable[[HomeAssistant, str, str, Any], ZendureDevice]] = {
        ...
        "solarflow 1600": SolarFlow1600,
        "solarflow 1600 pro": SolarFlow1600,
        "solarflow 1600 plus": SolarFlow1600,
